...
```bash
uv build && docker build -f docker/Dockerfile -t foundry-task-orchestration-actor:0.1.0 .
docker build --build-arg ACTOR_IMAGE=foundry-task-orchestration-actor:0.1.0 \
